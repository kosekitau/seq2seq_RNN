...
class EncoderRNN(nn.Module):
    def __init__(self, input_size, hidden_size, text_embedding_vectors):
...
class AttnDecoderRNN(nn.Module):
    ...
    def forward(self, input, hidden, encoder_outputs):
        ...
        query, hidden = self.lstm(embedded, hidden) # [1,1,256], [1,1,256]
...
encoder1 = EncoderRNN(input_lang.n_words, hidden_size, embedding_vector).to(device)
attn_decoder1 = AttnDecoderRNN(hidden_size,  embedding_vector, output_lang.n_words, dropout_p=0.1).to(device)
